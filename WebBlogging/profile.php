...
#myUL li a:hover:not(.header) {
  ...
  <div id="main">
    <header >
    <ul>
      <a href="#Hello"><img src="images/logo.png"height="40" width="160" align="left" id="logo" ></a>
...
-->
<li class="name" style="margin-left:900px;"><a href="timeline.php">Home</a></li>
  ...
  <div id='left_div' >
    <center>
      <img class="img-circle" src="<?php echo $dbdp;?>" alt="Image">
  ...
  <?php
    if(isset($_POST['postnew'])){
      ...
      if(!empty($topicnew) && !empty($contentnew)){
		...
		if($sql)
		{
			echo  "<script type='text/javascript'>alert('New post added successfully');</script>"; 
		}
