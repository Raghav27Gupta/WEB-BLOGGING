...
<!-------------------------------------------------------------------------------------------->
  ...
  <a href="timeline-blog.php">All Blogs</a>
...
img.onload = function() {
  ...
  <div class="upload-wrap">
    <button name="postimage" type="file" class="button" style=" color: #FFFFFF;height:-100%;margin-left:0%;width:30%;,padding-top:10%">
  ...
  <button class="button" name="postnew"  onclick=Refresh() style="height:50px; width:80px; padding-top:15px;padding-bottom:19px;margin-left:600px;z-index:1000;">
...
<?php
      ...
      if(!empty($_FILES['postphoto']['name']))
		{
				...
				echo "<script type='text/javascript'>alert('Data added successfully to table post with image');</script>";
       ...
       else
		{
                  ...
                  $result=mysql_query($sql);
				  echo "<script type='text/javascript'>alert('Data added successfully to table post without image');</script>";
        }
  ...
  FROM topic WHERE UserId='".$_SESSION["sess_user"]."' GROUP BY UserId ");
  while($row=mysql_fetch_assoc($query))
  {
    ...
    $sql ="SELECT * from post WHERE TopicId='$d1' OR TopicId='$d2' OR TopicId='$d3' OR TopicId='$d4' OR TopicId='$d5' ORDER BY Date DESC,Time DESC";
    $result = mysql_query($sql);
...
<div class="comment">
  ...
  <div class="container" style="margin-top:4px;margin-right:4px;position:relative;float:right">
  			<button class="btn btn-inside btn-boarder" id="<?php echo $dbpostid ?>"><img src="https://i.cloudup.com/gBzAn-oW_S-2000x2000.png" width="33px" height="40px" id="plane" ></button>
