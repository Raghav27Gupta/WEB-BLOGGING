            ...
            if(isset($_POST['upusername']) && isset($_POST['uppassword']) && isset($_POST['upfname']) && isset($_POST['uplname']))
				{
                      ...
                      mysql_connect("localhost","root","raghav") or die(mysql_error());
...
<div class="imageupload">
  <center><img src="<?php echo $dbdp;?>" alt="Your Image" id="imgdp" style="border-radius:100%;height:100%;width:100%;"class="imageupload1"></center>
  <div class="middle">
...
<div class="upload-wrap">
  ...
  <form method="post" action="" enctype="multipart/form-data">
    <input type="file" name="photo" class="upload-btn" id="photo" >
