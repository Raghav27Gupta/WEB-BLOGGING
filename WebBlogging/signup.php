...
<div class="slideshow-container" >
  ...
  <div class="mySlides fade" name="2" style="background:url('images/signup.png');">
    ...
    <div class="up">
     ...
     <input style="margin-left:1em;" type="text" class="TextBox" placeholder="Password" name="password" id="pass"><br>
     <input style="margin-left:1em;" type="text" class="TextBox" placeholder="Confirm Password"  id="pass1" onkeyup="check_pass1()"><br>
