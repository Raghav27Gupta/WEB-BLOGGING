...
<ul>
  ...
  -->
	<li style="float:right;"><a href="blog.php">Recent Blogs</a></li>
...
<footer class="footer-distributed" height="60" width="10" align="left">
   <div class="footer-left">
				<br><br><br><br><br>
				<p class="footer-links" height="60" width="50" align="left">
